...
from {{cookiecutter.package_name}} import rig, task_logic

SCHEMA_ROOT = Path("./src/DataSchemas/")
EXTENSIONS_ROOT = Path("./src/Extensions/")
NAMESPACE_PREFIX = "{{ cookiecutter.repository_name.replace('.', '') }}"


def main():
    models = [
        task_logic.{{ cookiecutter.class_suffix }}TaskLogic,
        rig.{{ cookiecutter.class_suffix }}Rig,

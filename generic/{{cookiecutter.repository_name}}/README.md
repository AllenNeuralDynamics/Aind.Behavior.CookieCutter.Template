...
![CI](https://github.com/AllenNeuralDynamics/{{ cookiecutter.repository_name }}/actions/workflows/ci.yml/badge.svg)
<!-- [![PyPI - Version](https://img.shields.io/pypi/v/aind-behavior-experiment-launcher)](https://pypi.org/project/{{ cookiecutter.package_name }}/) -->
